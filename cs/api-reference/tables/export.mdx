...
api: 'GET /v1/tables/{table_id}/export'
...
```bash cURL
# Export as JSON
curl -X GET "https://api.lasso.ai/v1/tables/tbl_abc123/export?format=json" \
  -H "Authorization: Bearer lasso_..."

# Export specific columns as CSV
curl -X GET "https://api.lasso.ai/v1/tables/tbl_abc123/export?format=csv&columns=name,price,url" \
  -H "Authorization: Bearer lasso_..." \
  -o export.csv
```
</RequestExample>
